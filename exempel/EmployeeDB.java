...
/**
   The Derby JDBC driver must be included in the classpath.

   Exemple, Unix: 

   java -cp /usr/share/javadb/lib/derby.jar:. EmployeeDB

   Example, Windows:

   java -cp "C:\Program Files\Java\jdk1.8.0_74\db\lib\derby.jar;." EmployeeDB
 */
class EmployeeDB {
